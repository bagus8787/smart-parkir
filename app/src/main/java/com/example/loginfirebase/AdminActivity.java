...
public class AdminActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText nama, lokasi, nama_image;
...
//                            Task<Uri> urlTask = taskSnapshot.getUploadSessionUri().getDownloadUrl();
                            ...
                            ParkirModel imageUploadInfo = new ParkirModel(namaa, lokasii,TempImageName,storageReference2nd.getDownloadUrl().toString(), namaa, status,lokasii);
    ...
    private void saveParkir() {
        ...
        if (! isEmptyFields) {
            ...
            Toast.makeText(AdminActivity.this, "Saving Data...", Toast.LENGTH_SHORT).show();
            ...
            //insert data
            dbMahasiswa.child(id).setValue(parkirModel);
